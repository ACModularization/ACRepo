...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is ModuleBCategory
                   DESC

  s.homepage     = "https://github.com/yymodularization/ModuleBCategory"
  ...
  s.source       = { :git => "https://github.com/yymodularization/ModuleBCategory.git", :tag => s.version.to_s }
  ...
  s.source_files  = "ModuleBCategory/ModuleBCategory/**/*.{h,m,swift}"
